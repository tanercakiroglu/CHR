...
public class LogInterceptor {
	...
	@Before(value = "com.chrental.aspect.logger.LogManager.auditLog()" + "&& target(bean) "
			+ "&& @annotation(com.chrental.aspect.logger.Loggable)" + "&& @annotation(logme)", argNames = "bean,logme")
	...
	@Around(value = "com.chrental.aspect.logger.LogManager.performanceLog()" + "&& target(bean) "
			+ "&& @annotation(com.chrental.aspect.logger.Loggable)" + "&& @annotation(logme)", argNames = "bean,logme")
